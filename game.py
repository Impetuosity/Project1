...
# Инициализация
pygame.init()
pygame.mixer.music.load('geoffplaysguitar-The-Only-Thing-I-Know-For-Real-_Instrumental_-Geoffrey-Day_-Andrew-Baena_-The-Mania.mp3')
...
class Animation(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = []
        self.images.append(pygame.image.load('sprite_00.png'))
        self.images.append(pygame.image.load('sprite_01.png'))
        self.images.append(pygame.image.load('sprite_02.png'))
        self.images.append(pygame.image.load('sprite_03.png'))
        self.images.append(pygame.image.load('sprite_04.png'))
        self.images.append(pygame.image.load('sprite_05.png'))
        self.images.append(pygame.image.load('sprite_06.png'))
        self.images.append(pygame.image.load('sprite_07.png'))
        self.images.append(pygame.image.load('sprite_08.png'))
        self.images.append(pygame.image.load('sprite_09.png'))
        self.images.append(pygame.image.load('sprite_10.png'))
        self.images.append(pygame.image.load('sprite_11.png'))
        self.images.append(pygame.image.load('sprite_12.png'))
        self.images.append(pygame.image.load('sprite_13.png'))
        self.images.append(pygame.image.load('sprite_14.png'))
        self.images.append(pygame.image.load('sprite_15.png'))
        self.images.append(pygame.image.load('sprite_16.png'))
        self.images.append(pygame.image.load('sprite_17.png'))
        self.images.append(pygame.image.load('sprite_18.png'))
        self.images.append(pygame.image.load('sprite_19.png'))
        self.images.append(pygame.image.load('sprite_20.png'))
        self.images.append(pygame.image.load('sprite_21.png'))
        self.images.append(pygame.image.load('sprite_22.png'))
        self.images.append(pygame.image.load('sprite_23.png'))
        self.images.append(pygame.image.load('sprite_24.png'))
        ...
        self.rect = pygame.Rect(825, 400, 300, 200)
...
class Batton:
    ...
    def draw_but(self):
        ...
        pygame.draw.rect(screen, self.Color, (width * 0.5 - width * 0.1 - int(20 * Size_k), self.text_y - int(20 * Size_k),
                                         width * 0.2 + int(40 * Size_k), self.text_h + int(40 * Size_k)), int(2 * Size_k), 50, 20)
